...
from Autumn.config import get_bool_key, get_int_key, get_list_key, get_str_key
from Autumn.services.telethon import tbot
from Autumn.utils.logger import log
from Autumn.versions import AUTUMN_VERSION

log.info("----------------------")
log.info("|      Autumn        |")
log.info("----------------------")
log.info("Version: " + AUTUMN_VERSION)

if get_bool_key("DEBUG_MODE") is True:
    AUTUMN_VERSION += "-debug"
