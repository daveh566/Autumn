...
from Autumn.function.pluginhelpers import member_permissions
from Autumn.services.pyrogram import pbot as app
...
*Note:
Sometimes, you promote or demote an admin manually, and Autumn doesn't realise it immediately. This is because to avoid spamming telegram servers, admin status is cached locally.
This means that you sometimes have to wait a few minutes for admin rights to update. If you want to update them immediately, you can use the /admincache command; that'll force Autumn to check who the admins are again.
"""
