...
from Autumn.services.mongo import mongodb as db
...
async def _(event):
    ...
    await tbot.edit_message(
        chatid,
        msgid,
        "kaykay found some torrents for you. Take a look 👇",
        buttons=[
            [
                Button.inline(
...
async def torrentstop(event):
    ...
    await tbot.edit_message(
        chatid,
        msgid,
        "Thanks for using.\n❤️ from [Autumn](t.me/famouskaykay) !",
        link_preview=False,
    )
...
and join our movies channel @intimacyfolksmovies 
"""
