...
from Autumn import BOT_USERNAME, OWNER_ID
from Autumn.config import get_str_key
from Autumn.function.pluginhelpers import convert_seconds_to_minutes as time_convert
from Autumn.function.pluginhelpers import fetch
...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/6a607f92fcd30b5537f07.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/famouskaykay_bot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[Autumn✨](https://github.com/famouskaykay):**
**MainBot:** `{bot_state}`
**UserBot:** `Alive`
**Python:** `3.9`
**Pyrogram:** `{pyrover}`
